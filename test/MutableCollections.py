...
# spark = SparkSession.builder.appName("MutableCollections").getOrCreate()
# 
# seq = spark.sparkContext.parallelize([0])
# 
# seq = seq.union(spark.sparkContext.parallelize([1, 2]))  # Alias for appendAll
# seq = seq.union(spark.sparkContext.parallelize([3, 4]))  # Append a sequence
# seq = seq.union(spark.sparkContext.parallelize([5]))  # Alias for addOne
# seq = seq.union(spark.sparkContext.parallelize([6]))  # Append one element
# seq = seq.union(spark.sparkContext.parallelize([7]))  # Append one element
# 
# assert seq.collect() == [0, 1, 2, 3, 4, 5, 6, 7]
# 
# seq = spark.sparkContext.parallelize([-2, -1]).union(seq)  # Alias for prependAll
# seq = spark.sparkContext.parallelize([-4, -3]).union(seq)  # Prepend a sequence
# seq = spark.sparkContext.parallelize([-5]).union(seq)  # Alias for prepend
# seq = spark.sparkContext.parallelize([-6]).union(seq)  # Prepend one element
# 
